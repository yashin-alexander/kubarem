...
void ThirdPersonCharacter::ProcessRotation()
{
    ...
    if (rotation_keeper_.IsMovingBothDirections()) {
        model_matrix = glm::rotate(model_matrix,
            rotation_keeper_.GetFrontDirection() * rotation_keeper_.CalculateFrontRotation(rotation_delta),
            rotation_keeper_.GetFrontDirection() * GetFront() + rotation_keeper_.GetRightDirection() * GetRight());
